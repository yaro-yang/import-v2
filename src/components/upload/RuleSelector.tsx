...
export function RuleSelector({
  ...
  return (
    <div className="space-y-4">
      ...
      {rules.length === 0 ? (
        <div className="py-10 lg:py-14 px-6 text-center bg-gradient-to-b from-[#fafbfc] to-white rounded-xl border border-dashed border-[#c9cdd4]">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#e8fafa] to-[#d4f5f3] flex items-center justify-center mx-auto mb-4 shadow-sm">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0fc6c2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="text-base font-medium text-[#1d2129] mb-1.5">暂无解析规则</p>
          <p className="text-sm text-[#86909c] mb-5 max-w-sm mx-auto">
