...
const sizeClasses = {
  sm: "!px-[28px] py-2.5 text-sm font-medium rounded-xl gap-1.5",
  md: "!px-[32px] py-3 text-base font-medium rounded-xl gap-2",
  lg: "!px-[36px] py-3.5 text-lg font-medium rounded-xl gap-2",
};
